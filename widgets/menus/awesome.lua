...
local awesome_menu = {
    ...
    {
        'Read &Manual',
        function() spawn(apps.awesome_manual) end,
        theme.awesome_manual_icon
    },
    {
        'Edit &Config',
        function() spawn(apps.awesome_config) end,
        theme.awesome_config_icon
    },
    {
        '&Restart Awesome',
        function() spawn(apps.awesome_restart) end,
        theme.awesome_restart_icon
    },
    {
        '&Exit Desktop',
        function()
            _G.session_action = { cmd = apps.awesome_exit, text = 'Exit Desktop', icon = theme.awesome_exit_icon }
